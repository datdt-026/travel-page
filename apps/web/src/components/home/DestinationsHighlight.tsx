      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-12 gap-4 md:gap-6">
          {featuredDestinations.map((destination, index) => {
            ...
            const layoutPatterns = [
              ...
              { colSpan: 'col-span-12 md:col-span-8', aspectRatio: 'aspect-[16/10]' },
              { colSpan: 'col-span-12 md:col-span-4', aspectRatio: 'aspect-[3/4] md:aspect-[3/4]' },
              // Row 2: Medium + Wide
              { colSpan: 'col-span-12 md:col-span-5', aspectRatio: 'aspect-[4/3]' },
              { colSpan: 'col-span-12 md:col-span-7', aspectRatio: 'aspect-[16/9]' },
            ...
            return (
              ...
              >
                {/* Image Container */}
                <div className={`relative overflow-hidden ${config.aspectRatio}`}>
                  {imageUrl ? (
                    <Image
                      src={imageUrl}
                  ...
                  <div className="transform transition-transform duration-500 group-hover:-translate-y-1">
                    ...
                    {destination.excerpt && (
                      <span 
                        ...
                        style={styling?.cardTextColor ? { color: styling.cardTextColor } : undefined}
                      >
                    ...
                    {/* Destination name */}
                    <h3 
                      className="font-serif text-xl md:text-2xl lg:text-3xl text-white tracking-wide leading-tight"
                    ...
                    {/* Hover reveal arrow */}
                    <div className="flex items-center gap-2 mt-3 md:mt-4 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-500">
                      <span className="text-xs uppercase tracking-[0.15em] text-white/80">Discover</span>
                      <svg 
        ...
        >
          <Link 
            ...
            style={{
              ...(styling?.buttonBackground ? { backgroundColor: styling.buttonBackground, borderColor: styling.buttonBackground } : {}),
              ...(styling?.buttonTextColor ? { color: styling.buttonTextColor } : {})
            }}
          >
            <span>{ctaText}</span>
            <svg 
